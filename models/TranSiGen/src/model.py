...
class TranSiGen(torch.nn.Module):
    ...
    def train_model(self, learning_rate, weight_decay, n_epochs, train_loader, test_loader, save_model=True, metrics_func=None, ablation_mode='none'):
        ...
        for epoch in range(n_epochs):
            ...
            # Eval
            train_dict, train_metrics_dict, train_metrics_dict_ls= self.test_model(loader=train_loader, loss_item=loss_item, metrics_func=metrics_func, ablation_mode=ablation_mode)
            ...
            test_dict, test_metrics_dict, test_metricsdict_ls= self.test_model(loader=test_loader, loss_item=loss_item, metrics_func=metrics_func, ablation_mode=ablation_mode)
