...
def parse_args():
    ...
    parser.add_argument("--use_mosa", action='store_true', help='Use MOSA cell features')
    parser.add_argument("--mosa_path", type=str, default='../data/MOSA/mosa_cell_features_200d.pickle', help='Path to MOSA features file')
    parser.add_argument("--debug_mosa", action='store_true', help='Enable MOSA debug prints')
...
def evaluate_TranSiGen(args):
    ...
    use_mosa = args.use_mosa
    mosa_path = args.mosa_path
    debug_mosa = args.debug_mosa
    ...
    print('use_mosa:', use_mosa, 'mosa_path:', mosa_path)
